-- Data Feed Settings Table
-- Stores configuration for each sport's data fetching behavior
...
-- Tracks health and execution of scheduled jobs
...
-- Manual Trigger Log
-- Tracks manual button clicks and their outcomes
