...
/**
 * SHIVA AUTO-PICKS CRON - SPREAD
 *
 * Runs every 8 minutes to automatically generate SHIVA SPREAD picks
 ...
 * - Each 8-minute cycle attempts ONLY ONE game
...
export async function GET(request: Request) {
  ...
  console.log(`\n${'='.repeat(80)}`)
  console.log(`🏀 [SHIVA-AUTO-PICKS-SPREAD] EXECUTION START: ${executionTime}`)
  console.log(`🔍 [SHIVA-AUTO-PICKS-SPREAD] REQUEST HEADERS:`, JSON.stringify({
  ...
  if (process.env.DISABLE_SHIVA_CRON === 'true') {
    console.log('🏀 [SHIVA-AUTO-PICKS-SPREAD] ⛔ KILL SWITCH ACTIVE - Cron is disabled via DISABLE_SHIVA_CRON env var')
  ...
  try {
    ...
    if (lockError) {
      console.error('🏀 [SHIVA-AUTO-PICKS-SPREAD] ❌ CRITICAL ERROR: Lock acquisition failed:', lockError)
      console.error('🏀 [SHIVA-AUTO-PICKS-SPREAD] ❌ This likely means the acquire_shiva_lock function does not exist!')
      console.error('🏀 [SHIVA-AUTO-PICKS-SPREAD] ❌ Falling back to manual lock check...')
      ...
      if (lockCheckError && lockCheckError.code !== 'PGRST116') {
        console.error('🏀 [SHIVA-AUTO-PICKS-SPREAD] ❌ CRITICAL ERROR: Lock check failed:', lockCheckError)
        return NextResponse.json({
          success: false,
      ...
      if (existingLock) {
        ...
        if (lockAge < lockTimeout) {
          console.log(`🏀 [SHIVA-AUTO-PICKS-SPREAD] ⚠️ SKIPPING - Another instance is running (locked ${Math.round(lockAge / 1000)}s ago by ${existingLock.locked_by})`)
          return NextResponse.json({
            success: false,
      ...
      if (upsertError) {
        console.error('🏀 [SHIVA-AUTO-PICKS-SPREAD] ❌ CRITICAL ERROR: Failed to acquire lock:', upsertError)
        return NextResponse.json({
          success: false,
      ...
      console.log(`🏀 [SHIVA-AUTO-PICKS-SPREAD] ⚠️ SKIPPING - Lock already held by another instance`)
      return NextResponse.json({
        success: false,
    ...
    console.log(`🏀 [SHIVA-AUTO-PICKS-SPREAD] ✅ Lock acquired: ${lockId}`)

    console.log('🏀 [SHIVA-AUTO-PICKS-SPREAD] Starting automated SHIVA SPREAD pick generation...')
    const startTime = Date.now()

    // Step 1: Find eligible games (excludes games in cooldown or already picked)
    console.log('🎯 [SHIVA-AUTO-PICKS-SPREAD] Finding eligible SPREAD games...')
    ...
    console.log(`🌐 [SHIVA-AUTO-PICKS-SPREAD] Using base URL: ${baseUrl}`)
    console.log(`🌐 [SHIVA-AUTO-PICKS-SPREAD] VERCEL_PROJECT_PRODUCTION_URL: ${process.env.VERCEL_PROJECT_PRODUCTION_URL}`)
    console.log(`🌐 [SHIVA-AUTO-PICKS-SPREAD] VERCEL_URL: ${process.env.VERCEL_URL}`)

    const scannerUrl = `${baseUrl}/api/shiva/step1-scanner`
    console.log(`🌐 [SHIVA-AUTO-PICKS-SPREAD] Calling scanner at: ${scannerUrl}`)
    ...
    console.log(`📡 [SHIVA-AUTO-PICKS-SPREAD] Scanner response status: ${scannerResponse.status}`)
    console.log(`📡 [SHIVA-AUTO-PICKS-SPREAD] Scanner response headers:`, Object.fromEntries(scannerResponse.headers.entries()))

    const responseText = await scannerResponse.text()
    console.log(`📡 [SHIVA-AUTO-PICKS-SPREAD] Scanner response body (first 500 chars):`, responseText.substring(0, 500))

    let scannerResult
    try {
      scannerResult = JSON.parse(responseText)
    } catch (parseError) {
      console.error('❌ [SHIVA-AUTO-PICKS-SPREAD] Failed to parse scanner response as JSON:', parseError)
      console.error('❌ [SHIVA-AUTO-PICKS-SPREAD] Response was:', responseText.substring(0, 1000))
      throw new Error(`Scanner returned non-JSON response: ${responseText.substring(0, 200)}`)
    }

    console.log('📊 [SHIVA-AUTO-PICKS-SPREAD] Scanner result:', scannerResult)

    if (!scannerResult.success || !scannerResult.selected_game) {
      console.log('⚠️ [SHIVA-AUTO-PICKS-SPREAD] No eligible SPREAD games found')
      const duration = Date.now() - startTime
      console.log(`\n${'='.repeat(80)}`)
      console.log(`⚠️ [SHIVA-AUTO-PICKS-SPREAD] EXECUTION COMPLETE: No eligible games`)
    ...
    console.log(`🎮 [SHIVA-AUTO-PICKS-SPREAD] Selected game: ${selectedGame.away_team.name} @ ${selectedGame.home_team.name}`)

    // Step 2: Run full pick generation pipeline
    console.log('⚡ [SHIVA-AUTO-PICKS-SPREAD] Running SPREAD pick generation...')
    ...
    console.log('📈 [SHIVA-AUTO-PICKS-SPREAD] Pick generation result:', pickResult)
    ...
    const releaseLock = async () => {
      try {
        ...
        if (error) {
          console.error('🏀 [SHIVA-AUTO-PICKS-SPREAD] Error releasing lock:', error)
        } else {
          console.log('🏀 [SHIVA-AUTO-PICKS-SPREAD] ✅ Lock released')
        }
      } catch (err) {
        console.error('🏀 [SHIVA-AUTO-PICKS-SPREAD] Error in releaseLock:', err)
      }
    }

    console.log(`\n${'='.repeat(80)}`)
    if (pickResult.decision === 'PICK' && pickResult.pick) {
      console.log(`✅ [SHIVA-AUTO-PICKS-SPREAD] EXECUTION COMPLETE: SPREAD pick generated`)
      console.log(`Duration: ${duration}ms`)
      console.log(`${'='.repeat(80)}\n`)
      ...
      return NextResponse.json({
        success: true,
        message: 'SHIVA SPREAD pick generated successfully',
        picksGenerated: 1,
      ...
      console.log(`⚠️ [SHIVA-AUTO-PICKS-SPREAD] EXECUTION COMPLETE: Game resulted in PASS (cooldown recorded)`)
      console.log(`Duration: ${duration}ms`)
      console.log(`${'='.repeat(80)}\n`)
      ...
      console.log(`❌ [SHIVA-AUTO-PICKS-SPREAD] EXECUTION COMPLETE: Unexpected result`)
      console.log(`Duration: ${duration}ms`)
      console.log(`${'='.repeat(80)}\n`)
    ...
    console.error('❌ [SHIVA-AUTO-PICKS-SPREAD] Error:', error)
