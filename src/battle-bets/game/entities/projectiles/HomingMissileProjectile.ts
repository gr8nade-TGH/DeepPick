...
export class HomingMissileProjectile extends BaseProjectile {
  ...
  public async animateToTarget(): Promise<void> {
    return new Promise((resolve) => {
      ...
      const dxTotal = this.targetPosition.x - this.position.x;
      const dyTotal = this.targetPosition.y - this.position.y;
      ...
      const duration = baseDuration * 1.1; // Slightly slower to emphasize homing arc
