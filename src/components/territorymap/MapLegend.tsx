...
export function MapLegend() {
  return (
    <div className="absolute bottom-4 right-4 bg-gradient-to-br from-slate-900 to-slate-800 border-2 border-amber-500 rounded-lg p-4 shadow-2xl max-w-xs max-h-[calc(100vh-12rem)] overflow-y-auto">
